...
VIEWS = (
    ...
    ("33_main_gate_block_wall", (22.4, -25.5, 3.0), (22.4, -14.5, 0.75), 45.0),
    ("34_utility_gate_block_wall", (74.4, 47.5, 3.0), (63.4, 47.5, 0.75), 45.0),
    ("35_gym_bridge_exterior", (27.0, 29.5, 8.0), (41.4, 29.5, 5.4), 46.0),
    ("36_gym_gallery_stairs", (46.4, -27.0, 15.0), (46.4, -6.0, 2.7), 28.0),
    ("37_gym_rooftop_connection", (65.0, 41.0, 18.0), (41.4, 28.8, 8.4), 44.0),
    ("38_west_extension", (-38.0, -24.0, 17.0), (-6.3, -5.2, 6.6), 45.0),
    ("39_elevator_shaft", (-24.0, -16.0, 10.5), (-10.3, -5.2, 7.2), 48.0),
    ("40_elevator_lobby_opening", (3.5, 1.0, 1.7), (-7.0, -4.5, 1.5), 48.0),
    ("41_gym_gallery_west_stair", (40.0, -4.8, 7.8), (35.0, -7.2, 2.7), 32.0),
    ("42_gym_gallery_east_stair", (52.8, -4.8, 7.8), (57.8, -7.2, 2.7), 32.0),
    ("43_elevator_waiting_mat", (-6.2, -5.2, 2.5), (-8.5, -5.2, 0.4), 58.0),
    ("44_elevator_closed_f02", (-6.2, -5.2, 5.4), (-8.6, -5.2, 4.8), 48.0),
    ("45_elevator_closed_f03", (-6.2, -5.2, 9.0), (-8.6, -5.2, 8.4), 48.0),
    ("46_elevator_hall_opening", (4.8, 1.9, 1.7), (-4.0, -4.2, 1.5), 42.0),
    ("47_gym_gallery_north_transitions", (41.4, 18.0, 10.5), (41.4, 25.6, 4.3), 38.0),
    ("48_gym_bridge_school_junction_f02", (37.75, 38.0, 5.3), (37.75, 32.5, 5.3), 16.0),
    ("49_gym_roof_ramp_school_junction_f03", (37.75, 38.0, 8.9), (37.75, 32.5, 8.35), 16.0),
    ("50_gym_gallery_north_transition_profile", (37.45, 18.0, 9.0), (37.45, 25.8, 4.3), 45.0),
    ("51_gym_roof_ramp_infill_west", (31.0, 29.5, 9.0), (41.4, 29.5, 7.6), 55.0),
    ("52_gym_bridge_gallery_floor_joint", (41.4, 30.5, 5.5), (41.4, 25.7, 3.7), 40.0),
    ("53_gym_gallery_west_inner_guards", (39.0, -7.0, 5.2), (35.1, -7.3, 2.5), 45.0),
    ("54_gym_gallery_east_inner_guards", (53.8, -7.0, 5.2), (57.7, -7.3, 2.5), 45.0),
    ("55_gym_roof_edge_infill", (64.0, 8.0, 10.0), (59.3, 8.0, 9.25), 65.0),
    ("56_gym_bridge_school_floor_joint", (41.4, 36.5, 5.1), (41.4, 31.5, 4.0), 40.0),
    ("57_gym_roof_ramp_school_joint_guards", (41.4, 27.0, 11.0), (41.4, 31.5, 7.8), 48.0),
    ("58_gym_roof_ramp_infill_south", (48.0, 22.0, 11.0), (41.4, 29.5, 8.0), 50.0),
    ("59_gym_gallery_west_stair_entry_guard", (39.0, -1.5, 2.4), (35.2, -4.2, 1.2), 50.0),
    ("60_gym_gallery_east_stair_entry_guard", (53.8, -1.5, 2.4), (57.6, -4.2, 1.2), 50.0),
    ("61_gym_bridge_school_terminal_interior", (41.4, 36.5, 5.1), (41.4, 31.5, 4.0), 40.0),
...
VIEW_SHOW_PREFIXES = {
    ...
    "39_elevator_shaft": (
        ...
        "VIS_B03_WestExtension",
        "VIS_B03_Floor_F",
        "VIS_RoofGuard_SouthOuter",
        "VIS_RoofGuard_WestOuter",
    ),
    "40_elevator_lobby_opening": (
        "VIS_B03_ElevatorStairWall",
        "VIS_B03_ElevatorShaft",
        "VIS_B03_WestExtension",
        "VIS_B03_Floor_F",
        "VIS_StairSystem_SW",
        "VIS_StairGuardSystem_SW",
    ),
    "41_gym_gallery_west_stair": (
        "VIS_Floor_Gym",
        "VIS_GymStage",
        "VIS_B03_GymStageSideWalls",
        "VIS_B03_GymGallery",
    ...
    "43_elevator_waiting_mat": (
        "VIS_B03_ElevatorWaitingMat",
        "VIS_B03_ElevatorShaft",
        "VIS_B03_ElevatorStairWall",
        "VIS_B03_WestExtension",
    ),
    "44_elevator_closed_f02": (
        "VIS_B03_ElevatorClosedDoor",
        "VIS_B03_ElevatorAdjustmentTape",
        "VIS_B03_ElevatorAdjustmentSign",
        "VIS_B03_ElevatorAdjustmentText",
        "VIS_B03_ElevatorStairWall",
    ),
    "45_elevator_closed_f03": (
        "VIS_B03_ElevatorClosedDoor",
        "VIS_B03_ElevatorAdjustmentTape",
        "VIS_B03_ElevatorAdjustmentSign",
        "VIS_B03_ElevatorAdjustmentText",
    ...
    "47_gym_gallery_north_transitions": (
        "VIS_Floor_Gym",
        "VIS_B03_GymBridge",
        "VIS_B03_GymGallery",
        "VIS_B03_GymExteriorWalls",
    ...
    "48_gym_bridge_school_junction_f02": (
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
    ...
    "49_gym_roof_ramp_school_junction_f03": (
        "VIS_B03_GymRoof",
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
        "VIS_B03_ExteriorWalls_F03",
        "VIS_B03_Floor_F03",
        "VIS_WindowFrame_F03_CourtyardNorth_Corridor_03",
        "VIS_WindowGlass_F03_CourtyardNorth_Corridor_03",
    ),
    "50_gym_gallery_north_transition_profile": (
        "VIS_Floor_Gym",
        "VIS_B03_GymBridge",
        "VIS_B03_GymGallery",
        "VIS_B03_GymExteriorWalls",
    ),
    "51_gym_roof_ramp_infill_west": (
        "VIS_B03_GymRoof",
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
        "VIS_B03_ExteriorWalls_F03",
    ...
    "52_gym_bridge_gallery_floor_joint": (
        "VIS_Floor_Gym",
        "VIS_B03_GymBridge",
        "VIS_B03_GymGallery",
        "VIS_B03_GymExteriorWalls",
    ),
    "53_gym_gallery_west_inner_guards": (
        "VIS_Floor_Gym",
        "VIS_GymStage",
        "VIS_B03_GymStageSideWalls",
        "VIS_B03_GymGallery",
    ...
    "54_gym_gallery_east_inner_guards": (
        "VIS_Floor_Gym",
        "VIS_GymStage",
        "VIS_B03_GymStageSideWalls",
        "VIS_B03_GymGallery",
    ...
    "55_gym_roof_edge_infill": (
        "VIS_B03_GymRoof",
        "VIS_B03_GymExteriorWalls",
        "VIS_Roof_Gym",
    ),
    "56_gym_bridge_school_floor_joint": (
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
        "VIS_B03_ExteriorWalls_F02",
        "VIS_B03_Floor_F02",
    ...
    "57_gym_roof_ramp_school_joint_guards": (
        "VIS_B03_GymRoof",
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
        "VIS_B03_ExteriorWalls_F03",
    ...
    "58_gym_roof_ramp_infill_south": (
        "VIS_B03_GymRoof",
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
        "VIS_Roof_Gym",
    ),
    "59_gym_gallery_west_stair_entry_guard": (
        "VIS_Floor_Gym",
        "VIS_GymStage",
        "VIS_B03_GymStageSideWalls",
        "VIS_B03_GymGallery",
    ...
    "60_gym_gallery_east_stair_entry_guard": (
        "VIS_Floor_Gym",
        "VIS_GymStage",
        "VIS_B03_GymStageSideWalls",
        "VIS_B03_GymGallery",
    ...
    "61_gym_bridge_school_terminal_interior": (
        "VIS_B03_GymBridge",
        "VIS_B03_GymExteriorWalls",
        "VIS_B03_ExteriorWalls_F02",
        "VIS_B03_Floor_F02",
    ...
    "62_gym_bridge_gallery_terminal_interior": (
        "VIS_Floor_Gym",
        "VIS_B03_GymBridge",
        "VIS_B03_GymGallery",
        "VIS_B03_GymExteriorWalls",
    ),
    "63_main_entry_six_lockers": (
        "VIS_B03_Interior_F01_MainEntry_FurnitureProps",
        "VIS_B03_Floor_F01",
        "VIS_B03_ExteriorWalls_F01",
        "VIS_B03_InteriorWalls_F01",
        "VIS_B03_WestExtension",
        "VIS_B03_ElevatorStairWall",
    ),
    "64_gym_south_passage": (
        "VIS_B03_GymExteriorWalls",
        "VIS_Perimeter_SouthEast",
        "VIS_Perimeter_SouthWest",
        "VIS_Perimeter_East",
