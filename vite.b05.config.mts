...
const allowlistedStageAssets = (): Plugin => ({
  name: "b05-allowlisted-3d-stage-assets",
...
export default defineConfig({
  root: resolve(repositoryRoot, "validation/v2/B05"),
  publicDir: false,
  base: "./",
  cacheDir: resolve(repositoryRoot, "node_modules/.vite-b05"),
  ...
  build: {
    target: "es2022",
    outDir: resolve(repositoryRoot, "dist/b05-validation"),
    emptyOutDir: true,
