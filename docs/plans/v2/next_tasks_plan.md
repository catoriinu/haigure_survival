...
- T06-1は`src/v2/**`を中心に、既存`drainPressedActions()`、NPC指示、扉操作、プレイヤー状態選択を通常ゲーム入口へ接続する。F／E／C・G／N／H、候補highlight・prompt、既定`roomDisorderLevel` 2、音声、水中速度、入力・Audio購読の開始・破棄を担当する。
