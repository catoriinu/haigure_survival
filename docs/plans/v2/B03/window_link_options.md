...
採用: **W02-R1（体育館南面窓なし・連続窓帯改訂版）**。校舎は各階18窓帯、全72窓帯とし、教室外周と中庭側廊下は腰壁上を高さ1.80m、幅4.80～9.60mの連続した窓面で覆う。各窓帯は左右2枚引違いユニット2～4組で構成する。体育館は北・東・西の上部に高さ2.40m、幅7.20mの窓帯を各3組置き、南面（舞台側）には窓を一切設けない。81窓帯のうち33組は、1ユニットの片側だけを開放する。
