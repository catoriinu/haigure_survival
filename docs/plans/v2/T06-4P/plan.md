...
- [x] T06-4P-1統合後にT06-4P-2を実装・検証・commitする
- [x] T06-4P-2の最終headでV3P第1磨き込み事前ゲートを通す

## 結果

P1文書段階として、T06-4Pを2つの直列batchへ分割した。実装、fixture追加、commitは未実施である。

2026-08-22、T06-4P-1統合済みの`origin/develop=c716331`を入力にT06-4P-2を実装した。公開待機定数を4秒へ変更し、T04実学校82/82、T05総合320/320、T05 NPC指示27/27、T06-3 16/16、T06-4 36/36、B05 42/42、通常人口Web／Electronを同一headで通過した。定員6人、全Actor先着順、既存予約保持、Followerの次便／階段選択、屋上入口192経路は維持し、学校バイナリと生成系は変更していない。正式なV3P独立ゲートはPull Request作成後のレビュー境界として残す。
