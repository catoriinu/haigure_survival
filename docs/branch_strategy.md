...
- T06-2は`cdb8bae`から`codex/v2-t06-school-integration`で単独開始し、開始候補、抽選方式、出現禁止Volume寸法、NPC／BIT出現Volume範囲のユーザー承認後に、ローカル実装・検証とPlayer開始地点別NPC近傍優先まで完了した。push、Pull Request、V3学校基盤機能ゲートは未実施である。
