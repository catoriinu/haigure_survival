...
export const createV2TitleSettingsPanel = ({
  ...
  const executionMethodLabels = Object.freeze({
    "player-bit": "PlayerをBITが処刑",
    "player-npc": "PlayerをNPCが処刑",
    "npc-bit": "NPCをBITが処刑",
    "npc-npc": "NPCをNPCが処刑",
    "npc-player": "NPCをPlayerが処刑"
  });
  appendOptions(
    executionMethod,
  ...
  const executionBitRow = createRow("周囲BIT数");
